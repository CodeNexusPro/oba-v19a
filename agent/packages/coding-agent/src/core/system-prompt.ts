/**
 * oba-v19a — prompt assembly with keyword-driven file discovery and style detection.
 * Builds the scoring preamble, task-aware hints, and project context sections.
 */
...
// oba-v19a: scoring-aligned preamble — steers toward minimal positional diffs.
